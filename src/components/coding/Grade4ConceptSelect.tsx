import agentVariables from "@/assets/agent_variables.png";
import agentFunctions from "@/assets/agent_functions.png";
import agentEvents from "@/assets/agent_events.png";
import agentCounters from "@/assets/agent_counters.png";
...
const concepts: Concept[] = [
  {
    ...
    image: agentVariables,
  },
  {
    id: "functions",
    name: "PROC",
    title: "Functions",
    perk: "Reusable Actions",
    color: "text-green-400",
    borderColor: "border-green-500",
    glowClass: "group-hover:shadow-[0_0_30px_rgba(34,197,94,0.5)]",
    image: agentFunctions,
  },
  {
    id: "events",
    name: "TRIGGER",
    title: "Events + Triggers",
    perk: "Interactive Coding",
    color: "text-pink-400",
...
export default function Grade4ConceptSelect({ onSelectConcept }: Grade4ConceptSelectProps) {
  return (
    <section className="relative z-20 mx-auto max-w-7xl px-6 pt-10 text-center animate-fade-in flex flex-col h-full justify-center">
      <div className="mb-10">
        ...
        <p className="mt-4 font-body text-sm text-muted-foreground max-w-2xl mx-auto">
          Master the core systems of the Coding Planet. Select your concept and deploy into the mainframe.
        </p>
      </div>
