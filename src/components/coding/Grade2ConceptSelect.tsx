import agentCauseEffect from "@/assets/agent_cause_effect.png";
import agentLoops from "@/assets/agent_loops.png";
import agentPathfinder from "@/assets/agent_pathfinder.png";
import agentMissions from "@/assets/agent_missions.png";
...
const concepts: Concept[] = [
  {
    id: "cause_effect",
    name: "BLAZE",
    title: "Cause & Effect Logic",
    perk: "Predict enemy attacks",
    color: "text-orange-400",
    borderColor: "border-orange-500",
    glowClass: "group-hover:shadow-[0_0_30px_rgba(249,115,22,0.5)]",
    image: agentCauseEffect,
  },
  {
    id: "loops",
    name: "ORBIT",
    title: "Repetition (Loops)",
    perk: "Actions repeat faster",
    color: "text-teal-400",
  ...
  },
  {
    ...
    perk: "Reveals shortest route",
    color: "text-pink-400",
    borderColor: "border-pink-500",
    glowClass: "group-hover:shadow-[0_0_30px_rgba(236,72,153,0.5)]",
    image: agentPathfinder,
  },
  {
    id: "missions",
    name: "PRIME",
    title: "Goal-Based Tasks",
    perk: "+20% mission rewards",
    color: "text-yellow-400",
    borderColor: "border-yellow-500",
    glowClass: "group-hover:shadow-[0_0_30px_rgba(234,179,8,0.5)]",
    image: agentMissions,
  },
];

export default function Grade2ConceptSelect({ onSelectConcept }: Grade2ConceptSelectProps) {
  return (
    <section className="relative z-20 mx-auto max-w-7xl px-6 pt-10 text-center animate-fade-in flex flex-col h-full justify-center">
      <div className="mb-10">
        ...
        <p className="mt-4 font-body text-sm text-muted-foreground max-w-2xl mx-auto">
          These elite operatives handle complex missions. Pick your specialist and push deeper into the mainframe.
        </p>
      </div>
