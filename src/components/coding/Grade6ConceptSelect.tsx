import agentPythonOutput from "@/assets/agent_python_output.png";
import agentPythonVariables from "@/assets/agent_python_variables.png";
import agentPythonIfElse from "@/assets/agent_python_ifelse.png";
import agentPythonLoops from "@/assets/agent_python_loops.png";
...
const concepts: Concept[] = [
  {
    ...
    perk: "Display Messages",
    color: "text-emerald-400",
    borderColor: "border-emerald-500",
    glowClass: "group-hover:shadow-[0_0_30px_rgba(52,211,153,0.5)]",
    image: agentPythonOutput,
  },
  {
    id: "python_variables",
    name: "MEM",
    ...
    glowClass: "group-hover:shadow-[0_0_30px_rgba(34,211,238,0.5)]",
    image: agentPythonVariables,
  },
  {
    id: "python_ifelse",
    name: "FORK",
    title: "If–Else",
    perk: "Basic Conditions",
    color: "text-fuchsia-400",
    borderColor: "border-fuchsia-500",
    glowClass: "group-hover:shadow-[0_0_30px_rgba(232,121,249,0.5)]",
    image: agentPythonIfElse,
  },
  {
    id: "python_loops",
    name: "SYNC",
    ...
    glowClass: "group-hover:shadow-[0_0_30px_rgba(251,146,60,0.5)]",
    image: agentPythonLoops,
  },
];

export default function Grade6ConceptSelect({ onSelectConcept }: Grade6ConceptSelectProps) {
  return (
    <section className="relative z-20 mx-auto max-w-7xl px-6 pt-10 text-center animate-fade-in flex flex-col h-full justify-center">
      <div className="mb-10">
        ...
        <p className="mt-4 font-body text-sm text-muted-foreground max-w-2xl mx-auto">
          Welcome to real code. Master Python syntax and logic to take full control of the Coding Planet.
        </p>
      </div>
